...
namespace BloodyBoss.Configuration
{
    internal class PluginConfig
    {
        ...
        public static ConfigEntry<bool> KillingMessage { get; private set; }
        ...
        public static void Initialize()
        {
            ...
            KillingMessage = _mainConfig.Bind("Main", "EnableKillMessage", false, "If you activate this option it will show a killing message.");
        }
